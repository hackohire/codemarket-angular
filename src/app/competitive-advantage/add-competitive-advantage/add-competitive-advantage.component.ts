...
@Component({
  selector: 'app-add-competitive-advantage',
  templateUrl: './add-competitive-advantage.component.html',
  styleUrls: ['./add-competitive-advantage.component.scss']
})
export class AddCompetitiveAdvantageComponent implements OnInit {
  breadcumb: BreadCumb;
  postForm: FormGroup;
  ...
  constructor(
    ...
    this.breadcumb = {
      ...
      path: [
        ...
        {
          name: CompanyPostTypes.CompetitiveAdvantage
        }
      ]
    };

     /** Make the Changes here while creating new post type */
    if (this.activatedRoute.snapshot.parent.routeConfig.path === `add-${CompanyPostTypes.CompetitiveAdvantage}`) {
  ...
  postFormInitialization(i: Post) {
    this.postForm = new FormGroup({
      ...
      // change this line
      type: new FormControl(CompanyPostTypes.CompetitiveAdvantage),
    });
  }
