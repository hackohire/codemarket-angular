...
export class AttachesTool {
  ...
  CustomFileIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="40">
  ...
  DownloadIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="17pt" height="17pt" viewBox="0 0 17 17">
  ...
  prepareUploadButton() {
    ...
    this.nodes.button.innerHTML = `${this.Icon} ${this.config.buttonText}`;
  ...
  appendFileIcon() {
    ...
    const extensionColor = AttachesTool.EXTENSIONS[extension];

    const fileIcon = this.make('div', this.CSS.fileIcon, {
      innerHTML: extensionColor ? this.CustomFileIcon : this.FileIcon
    });
