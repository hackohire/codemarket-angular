...
export class AddTeamChallengeComponent implements OnInit {
  ...
  constructor(
    ...
    this.breadcumb = {
      ...
      path: [
        ...
        {
          name: CompanyPostTypes.TeamChallenge
        }
      ]
    };

     /** Make the Changes here while creating new post type */
    if (this.activatedRoute.snapshot.parent.routeConfig.path === `add-${CompanyPostTypes.TeamChallenge}`) {
  ...
  postFormInitialization(i: Post) {
    this.postForm = new FormGroup({
      ...
      // change this line
      type: new FormControl(CompanyPostTypes.TeamChallenge),
    });
  }
