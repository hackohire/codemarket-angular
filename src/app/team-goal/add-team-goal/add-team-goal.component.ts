...
@Component({
  selector: 'app-add-team-goal',
  templateUrl: './add-team-goal.component.html',
  styleUrls: ['./add-team-goal.component.scss']
})
export class AddTeamGoalComponent implements OnInit {
  ...
  constructor(
    ...
    this.breadcumb = {
     ...
     /** Make the Changes here while creating new post type */
    if (this.activatedRoute.snapshot.parent.routeConfig.path === `add-${CompanyPostTypes.TeamGoal}`) {
  ...
  postFormInitialization(i: Post) {
    this.postForm = new FormGroup({
      ...
      // change this line
      type: new FormControl(CompanyPostTypes.TeamGoal),
    });
  }
