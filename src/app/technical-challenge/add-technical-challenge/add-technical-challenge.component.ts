...
@Component({
  selector: 'app-add-technical-challenge',
  templateUrl: './add-technical-challenge.component.html',
  styleUrls: ['./add-technical-challenge.component.scss']
})
export class AddTechnicalChallengeComponent implements OnInit {
  breadcumb: BreadCumb;
  postForm: FormGroup;
  ...
  constructor(
    ...
    this.breadcumb = {
      title: 'Add Technical Challenge Details',
      path: [
        {
          name: CompanyPostTypes.TechnicalChallenge
        }
      ]
    };

     /** Make the Changes here while creating new post type */
    if (this.activatedRoute.snapshot.parent.routeConfig.path === `add-${CompanyPostTypes.TechnicalChallenge}`) {
  ...
  postFormInitialization(i: Post) {
    this.postForm = new FormGroup({
      ...
      // change this line
      type: new FormControl(CompanyPostTypes.TechnicalChallenge),
    });
  }
