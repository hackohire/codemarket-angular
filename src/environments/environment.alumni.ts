...
export const environment = {
  ...
  serverless_url: 'https://alumniapi.codemarket.io/',
  graphql_url: 'https://alumniapi.codemarket.io/graphql',
  s3FilesBucketURL: 'https://alumni-files.s3.amazonaws.com/public/',
  stripe_public_key: 'pk_live_EYCoYtpLszr802sOl89WeuW1',
  // stripe_public_key: 'pk_test_ighmL2U9UqAx0O4b8dKkSvdq',
  webSocketURL: 'wss://8besb58jve.execute-api.us-east-1.amazonaws.com/alumni',
  // planDetails: plans.prod,
  planDetails: plans.prod,
  fileS3Bucket: 'alumni-files',
  oauth: {
    // Domain name
