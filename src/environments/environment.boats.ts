...
export const environment = {
  ...
  production: true,
  serverless_url: 'https://boatsapi.codemarket.io/',
  graphql_url: 'https://boatsapi.codemarket.io/graphql',
  s3FilesBucketURL: 'https://boats-files.s3.amazonaws.com/public/',
  stripe_public_key: 'pk_live_EYCoYtpLszr802sOl89WeuW1',
  // stripe_public_key: 'pk_test_ighmL2U9UqAx0O4b8dKkSvdq',
  webSocketURL: 'wss://m9jybwxuxh.execute-api.us-east-1.amazonaws.com/boats',
  // planDetails: plans.prod,
  planDetails: plans.prod,
  fileS3Bucket: 'boats-files',
  oauth: {
    // Domain name
