...
export const environment = {
  ...
  ckEditor: {
    ckEditorEnvironMentId: '5OgsvqWDG6xC3VXY17lL',
    ckEditorSecretKey: 'nrKe5ANkb47Dcsxo8TwMNUwJXVrK1TSH2auQZhIcR7ZFrLyhrSPyQDYvcQSW',
  ...
  production: true,
  serverless_url: 'https://dev2api-prod.codemarket.io/',
  graphql_url: 'https://dev2api-prod.codemarket.io/graphql',
  s3FilesBucketURL: 'https://dev2-files.s3.amazonaws.com/public/',
