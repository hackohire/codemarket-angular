...
export const environment = {
  ...
  serverless_url: 'https://jigneshapi.codemarket.io/',
  graphql_url: 'https://jigneshapi.codemarket.io/graphql',
  s3FilesBucketURL: 'https://jignesh-files.s3.amazonaws.com/public/',
  stripe_public_key: 'pk_live_EYCoYtpLszr802sOl89WeuW1',
  // stripe_public_key: 'pk_test_ighmL2U9UqAx0O4b8dKkSvdq',
  webSocketURL: 'wss://muqky3soue.execute-api.us-east-1.amazonaws.com/jignesh',
  // planDetails: plans.prod,
  planDetails: plans.prod,
  fileS3Bucket: 'jignesh-files',
  oauth: {
    // Domain name
