...
export const environment = {
  ...
  production: true,
  serverless_url: 'https://khushbuapi.codemarket.io/',
  graphql_url: 'https://khushbuapi.codemarket.io/graphql',
  s3FilesBucketURL: 'https://khushbu-files.s3.amazonaws.com/public/',
  stripe_public_key: 'pk_live_EYCoYtpLszr802sOl89WeuW1',
  // stripe_public_key: 'pk_test_ighmL2U9UqAx0O4b8dKkSvdq',
  webSocketURL: 'wss://2e7xcknvkc.execute-api.us-east-1.amazonaws.com/khushbu',
  // planDetails: plans.prod,
  planDetails: plans.prod,
  fileS3Bucket: 'khushbu-files',
  oauth: {
    // Domain name
