...
export const environment = {
  ...
  serverless_url: 'https://joyapi.codemarket.io/',
  graphql_url: 'https://joyapi.codemarket.io/graphql',
  s3FilesBucketURL: 'https://joy-files.s3.amazonaws.com/public/',
  stripe_public_key: 'pk_live_EYCoYtpLszr802sOl89WeuW1',
  // stripe_public_key: 'pk_test_ighmL2U9UqAx0O4b8dKkSvdq',
  webSocketURL: 'wss://nse3tn6wnl.execute-api.us-east-1.amazonaws.com/joy',
