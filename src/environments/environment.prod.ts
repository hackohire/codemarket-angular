...
export const environment = {
  ...
  serverless_url: 'https://iitalumniapi.codemarket.io/',
  graphql_url: 'https://iitalumniapi.codemarket.io/graphql',
  s3FilesBucketURL: 'https://iitalumni-files.s3.amazonaws.com/public/',
  stripe_public_key: 'pk_live_EYCoYtpLszr802sOl89WeuW1',
  // stripe_public_key: 'pk_test_ighmL2U9UqAx0O4b8dKkSvdq',
  webSocketURL: 'wss://heto6q2h93.execute-api.us-east-1.amazonaws.com/iitalumni',
