...
export const environment = {
  ...
  serverless_url: 'https://jobs.codemarket.io/',
  graphql_url: 'https://jobs.codemarket.io/graphql',
  ...
  webSocketURL: 'wss://do7y7jdud7.execute-api.us-east-1.amazonaws.com/jobs',
