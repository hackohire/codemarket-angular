...
export const environment = {
  ...
  serverless_url: 'https://uq46wmfd9a.execute-api.ap-south-1.amazonaws.com/endcancer2/',
  graphql_url: 'https://uq46wmfd9a.execute-api.ap-south-1.amazonaws.com/endcancer2/graphql',
