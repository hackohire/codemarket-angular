...
export const environment = {
  ...
  serverless_url: 'https://healthapi.codemarket.io/',
  graphql_url: 'https://healthapi.codemarket.io/graphql',
  s3FilesBucketURL: 'https://health-file.s3.amazonaws.com/public/',
  stripe_public_key: 'pk_live_EYCoYtpLszr802sOl89WeuW1',
  // stripe_public_key: 'pk_test_ighmL2U9UqAx0O4b8dKkSvdq',
  webSocketURL: 'wss://ddi142eh93.execute-api.us-east-1.amazonaws.com/healths',
