...
export const environment = {
  ...
  production: true,
  serverless_url: 'https://sendemailapi.codemarket.io/',
  graphql_url: 'https://sendemailapi.codemarket.io/graphql',
  ...
  webSocketURL: 'wss://wrp96icfil.execute-api.us-east-1.amazonaws.com/sendemails',
