...
export const environment = {
  ...
  serverless_url: 'https://9bzn0a9f3e.execute-api.ap-south-1.amazonaws.com/goodclub/',
  graphql_url: 'https://9bzn0a9f3e.execute-api.ap-south-1.amazonaws.com/goodclub/graphql',
  s3FilesBucketURL: 'https://goodclub-files.s3.amazonaws.com/public/',
