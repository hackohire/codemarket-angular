...
export const environment = {
  ...
  serverless_url: 'https://d8zu7hxm3m.execute-api.ap-south-1.amazonaws.com/endcancer',
  graphql_url: 'https://d8zu7hxm3m.execute-api.ap-south-1.amazonaws.com/endcancer/graphql',
  s3FilesBucketURL: 'https://endcancer-files.s3.amazonaws.com/public/',
