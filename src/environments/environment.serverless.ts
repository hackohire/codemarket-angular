...
export const environment = {
  ...
  serverless_url: 'https://oh5h1wp924.execute-api.ap-south-1.amazonaws.com/goalmarket/',
  graphql_url: 'https://oh5h1wp924.execute-api.ap-south-1.amazonaws.com/goalmarket/graphql',
  s3FilesBucketURL: 'https://goalmarket-files.s3.amazonaws.com/public/',
