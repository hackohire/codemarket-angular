...
export const environment = {
  ...
  serverless_url: 'https://jane-api.codemarket.io/',
  graphql_url: 'https://jane-api.codemarket.io/graphql/graphql',
  s3FilesBucketURL: 'https://jane-files.s3.amazonaws.com/public/',
  stripe_public_key: 'pk_live_EYCoYtpLszr802sOl89WeuW1',
  // stripe_public_key: 'pk_test_ighmL2U9UqAx0O4b8dKkSvdq',
  webSocketURL: 'wss://jiqc67f9v6.execute-api.us-east-1.amazonaws.com/jane',
  ...
  oauth: {
    ...
    // Callback URL
    redirectSignIn: 'https://www.jane.io', // or 'exp://127.0.0.1:19000/--/', 'myapp://main/'

    // Sign out URL
    redirectSignOut: 'https://www.jane.io', // or 'exp://127.0.0.1:19000/--/', 'myapp://main/'
