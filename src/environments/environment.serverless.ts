...
export const environment = {
  ...
  serverless_url: 'https://fuj03ggzrb.execute-api.ap-south-1.amazonaws.com/petclub/',
  graphql_url: 'https://fuj03ggzrb.execute-api.ap-south-1.amazonaws.com/petclub/graphql',
  s3FilesBucketURL: 'https://petclub-files.s3.amazonaws.com/public/',
