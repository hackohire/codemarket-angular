...
export const environment = {
  ...
  production: true,
  serverless_url: 'https://technothateapi.codemarket.io/',
  graphql_url: 'https://technothateapi.codemarket.io/graphql',
  ...
  webSocketURL: 'wss://v25y4plnh4.execute-api.us-east-1.amazonaws.com/technothate',
