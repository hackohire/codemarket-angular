...
export const environment = {
  ...
  production: true,
  serverless_url: 'https://therapyapi.codemarket.io/',
  graphql_url: 'https://therapyapi.codemarket.io/graphql',
  s3FilesBucketURL: 'https://therapy-files.s3.amazonaws.com/public/',
  stripe_public_key: 'pk_live_EYCoYtpLszr802sOl89WeuW1',
  // stripe_public_key: 'pk_test_ighmL2U9UqAx0O4b8dKkSvdq',
  webSocketURL: 'wss://nm46wccex9.execute-api.us-east-1.amazonaws.com/therapy',
  // planDetails: plans.prod,
  planDetails: plans.prod,
  fileS3Bucket: 'therapy-files',
  oauth: {
    // Domain name
