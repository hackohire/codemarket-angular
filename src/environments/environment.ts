...
export const environment = {
  ...
  serverless_url: 'https://q4shljq9z7.execute-api.ap-south-1.amazonaws.com/writersclub/',
  graphql_url: 'https://q4shljq9z7.execute-api.ap-south-1.amazonaws.com/writersclub/graphql',
  applicationId: '5d2ef428bbfa6576b357d5d4',
  s3FilesBucketURL: 'https://writersclub-files.s3.amazonaws.com/public/',
